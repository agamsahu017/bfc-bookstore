                ...
                <div className="form_block w-100">
                  <form id="login-form" onSubmit={submitHandler}>
                    ...
                    <button type="submit" className="btn btn-register" id="login_button">
                      Sign In</button>
                    <hr /> 
                    <p className="dont_h_a mb-0 =">Don't have an account? <Link to={redirect === "/" ? "register":"register?redirect="+redirect}  className="text-warning">Register an Account </Link></p>
                  </form>
                </div>
              </div>
            </div>
