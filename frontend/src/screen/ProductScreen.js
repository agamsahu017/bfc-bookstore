...
const dispatch = useDispatch();
	...
	return loading? <div>Loading...</div>:
                        ...
                        <div id="myCarousel" className="carousel slide" data-ride="carousel">
                          <div className="carousel-inner">
                            <div className="carousel-item img-magnifier-container active" data-slide-number={0}>
                              <img src={ product.image } id="myimage" className="d-block w-100 about-img-1 magnifiedImg" alt="..." data-remote={img1} data-type="image" data-toggle="lightbox" data-gallery="example-gallery" />
                            </div>
      ...
      <li>Status : {product.countInStock >0 ? "In Stock": "Unavialable"}</li>
                        </ul>
                      </div>
                      <div className="highlight">
                    ...
                    >
                      ...
                      <hr />
                      <div className="check">
                        <h5 className="mb-4 text-danger">Also Avaliabl.</h5>
